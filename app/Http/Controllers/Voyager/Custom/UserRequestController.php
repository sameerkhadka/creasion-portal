...
class UserRequestController extends VoyagerBaseController
{
    ...
    public function destroy(Request $request, $id)
    {
         ...
         * automatically.
         * 1) delete response to that user request if exists
         * 2) delete individual or institution data
         * 3) delete inventory/user_requests pivot table data ( only deleted user_requests )
         * 4) delete inventory/response pivot table data ( if responded )
         *  */
