                ...
                <div id="app" class="panel panel-bordered">
                    ...
                    <form role="form" class="form-edit-add"
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group  col-md-3 ">
                                <label class="control-label"
                                    for="name">{{ $user_request->individual_id ? 'Name' : 'Organization Name' }}</label>
                            ...
                            <div class="form-group  col-md-3 ">
                                ...
                                <input type="text" class="form-control" value="{{ optional($user->province)->title_en }}"
                                    readonly>
                            </div>

                            <div class="form-group  col-md-3 ">
                                <label class="control-label" for="name">District</label>
                                <input type="text" class="form-control" value="{{ optional($user->district)->title_en }}"
                                    readonly>
                            </div>
                            ...
                            <div class="form-group  col-md-12 ">
                                <label class="control-label" for="name">Requested Data</label>
                                ...
                                <div v-for="(item,index) in respondedItems">
                                    <div class="form-group  col-md-6 ">
                                        ...
                                        <select class="form-control" v-model="item.inventory_id">
                                            ...
                                            <option :value="inventory.id" v-for="inventory in inventories">
                                    ...
                                    <div class="form-group  col-md-1" v-if="index!=0">
                                        ...
                                        <input class="btn btn-danger" type="button" v-on:click="deleteItem(index)"
                                            value="Delete">
                                    </div>
                        ...
                        <div class="panel-footer">
                            <input :disabled="submitting" v-on:click="addItem" class="btn btn-success" type="button"
                                value="Add Items">

                        @section('submit-buttons')
                            <button :disabled="submitting" v-on:click="submitData"
                                class="btn btn-primary save">{{ __('voyager::generic.save') }}</button>
                        @stop

                        @yield('submit-buttons')
                        <input :disabled="submitting" onclick="window.location=document.referrer;"
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/vuejs-datepicker/1.6.2/vuejs-datepicker.min.js"
integrity="sha512-SxUBqfNhPSntua7WUkt171HWx4SV4xoRm14vLNsdDR/kQiMn8iMUeopr8VahPpuvRjQKeOiMJTJFH5NHzNUHYQ=="
crossorigin="anonymous" referrerpolicy="no-referrer"></script>
