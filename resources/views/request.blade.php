...
<html lang="en">
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="header-logo">
                        <a href="{{ route('index') }}"> NEPAL RELIEF <span>PORTAL</span> </a>
                    </div>
    ...
    ></script>
    <script
        src="https://cdnjs.cloudflare.com/ajax/libs/vuejs-datepicker/1.6.2/vuejs-datepicker.min.js"
